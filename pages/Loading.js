 ...
 return (
  <section className="py-24">
   ...
   <div className="bg-white p-2 sm:p-4 sm:h-64 rounded-2xl shadow-lg flex flex-col sm:flex-row gap-5 select-none ">
      <div className="h-52 sm:h-full sm:w-72 rounded-xl bg-gray-200 animate-pulse" ><div className="text-sm align-text-top text-center text-slate-900 content-center py-24">... SEARCHING</div></div>
   ...
   <div className="max-w-xs sm:max-w-2xl  mx-auto py-5">
   <div className="bg-white p-2 sm:p-4 sm:h-64 rounded-2xl shadow-lg flex flex-col sm:flex-row gap-5 select-none ">
      <div className="h-52 sm:h-full sm:w-72 rounded-xl bg-gray-200 animate-pulse" ><div className="text-sm align-text-top text-center text-slate-900 content-center py-24">... SEARCHING</div></div>
      <div className="flex flex-col flex-1 gap-5 sm:p-2">
        <div className="flex flex-1 flex-col gap-3">
